...
public class WadauRequestTest {
    ...
    public void testDeserializeWadauRequest() throws IOException {
        ...
        Assert.assertEquals("Rasello team", requests.get(0).getName());
        Assert.assertEquals("#00fa92", requests.get(0).getColour());
        Assert.assertEquals("this is the final demo", requests.get(0).getDescription());
        ...
        Assert.assertEquals("Test 2", requests.get(1).getName());
        Assert.assertEquals("#FFFFFF", requests.get(1).getColour());
        Assert.assertEquals("Description 2", requests.get(1).getDescription());
    ...
    public void testSerializeWadauRequest() {
        ...
        Assert.assertTrue(actual.contains(request.getDescription()));
